...
exports.sendOpAlert = function (errObj, codePart, pageId, userId, companyId) {
  let email = getEmailObject(['sojharo@cloudkibo.com', 'jawaid@cloudkibo.com', 'faizan@cloudkibo.com'], 'support@cloudkibo.com', 'KiboPush: Facebook Error', 'Facebook Error', errObj.message, codePart, pageId, userId, companyId)
