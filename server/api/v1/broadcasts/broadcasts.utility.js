...
const TagSubscribersDataLayer = require('./../tags_subscribers/tags_subscribers.datalayer')
...
function applyTagFilterIfNecessary (req, subscribers, fn) {
  if (req.body.segmentationTags && req.body.segmentationTags.length > 0) {
    TagSubscribersDataLayer.genericFind({ tagId: { $in: req.body.segmentationTags } })
      .then(tagSubscribers => {
