...
exports.testCommonBatchAPI = function (req, res) {
  let payload = [
    ...
    },
    {
      ...
      componentType: 'media',
      fileurl: {
        id: 'f85898f34a82019101102834.jpeg',
        attachment_id: '3023022401106157',
        name: 'photo-1523895665936-7bfe172b757d.jpeg',
        url: 'https://accounts.cloudkibo.com/api/v1/files/download/f85898f34a82019101102834.jpeg'
      },
      fileName: 'photo-1523895665936-7bfe172b757d.jpeg',
      image_url: 'https://accounts.cloudkibo.com/api/v1/files/download/f85898f34a82019101102834.jpeg',
      size: 404846,
      type: 'image/jpeg',
      mediaType: 'image',
      buttons: []
    },
    {
      ...
      cards: [
        {
          fileurl: {
            id: 'ff0fabdfb712019101103318.jpeg',
            name: 'D3rnC2WUUAENrRw.jpeg',
            url: 'https://accounts.cloudkibo.com/api/v1/files/download/ff0fabdfb712019101103318.jpeg'
          },
          image_url: 'https://accounts.cloudkibo.com/api/v1/files/download/ff0fabdfb712019101103318.jpeg',
          fileName: 'D3rnC2WUUAENrRw.jpeg',
          type: 'image/jpeg',
          size: 41249,
          title: 'Card 1',
          subtitle: 'Sub 1',
          buttons: [
            {
              title: 'Button 1',
              type: 'web_url',
              url: 'https://kiboengage.cloudkibo.com/api/URL/broadcast/5d932bff137d223f8acc71c6'
            }
          ]
        },
        {
          fileurl: {
            id: 'f89aae6ae9a201910110348.jpeg',
            name: 'images.jpeg',
            url: 'https://accounts.cloudkibo.com/api/v1/files/download/f89aae6ae9a201910110348.jpeg'
          },
          image_url: 'https://accounts.cloudkibo.com/api/v1/files/download/f89aae6ae9a201910110348.jpeg',
          ...
          buttons: [
            {
              title: 'Button 2',
              type: 'web_url',
              url: 'https://kiboengage.cloudkibo.com/api/URL/broadcast/5d932bff137d223f8acc71c7'
            }
          ]
        },
        {
          fileurl: {
            id: 'f3ac3256a862019101103520.jpg',
            name: 'PUBG-Flare-Gun-1000x560.jpg',
            url: 'https://accounts.cloudkibo.com/api/v1/files/download/f3ac3256a862019101103520.jpg'
          },
          image_url: 'https://accounts.cloudkibo.com/api/v1/files/download/f3ac3256a862019101103520.jpg',
          fileName: 'PUBG-Flare-Gun-1000x560.jpg',
          type: 'image/jpeg',
          size: 52095,
          title: 'Card 3',
          subtitle: 'Sub 3',
          buttons: [
            {
              title: 'Button 3',
              type: 'web_url',
              url: 'https://kiboengage.cloudkibo.com/api/URL/broadcast/5d932bff137d223f8acc71c8'
            }
          ]
        }
      ]
