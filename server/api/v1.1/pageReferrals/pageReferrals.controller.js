...
exports.create = function (req, res) {
  utility.callApi(`companyUser/query`, 'post', { domain_email: req.user.domain_email }, req.headers.authorization)
    .then(companyUser => {
      ...
      utility.callApi(`pageReferrals/query`, 'post', {pageId: req.body.pageId, companyId: req.user.companyId}, req.headers.authorization)
        .then(pageReferrals => {
...
exports.update = function (req, res) {
  utility.callApi(`companyUser/query`, 'post', { domain_email: req.user.domain_email }, req.headers.authorization)
    .then(companyUser => {
      ...
      utility.callApi(`pageReferrals/query`, 'post', {_id: req.body._id, companyId: req.user.companyId}, req.headers.authorization)
        .then(pageReferrals => {
