...
exports.view = function (req, res) {
  utility.callApi(`pageReferrals/query`, 'post', {_id: req.params.id, companyId: req.user.companyId})
    ...
    .catch(error => {
      const message = error || 'Internal Server Error'
      logger.serverLog(message, `${TAG}: exports.view`, req.body, {user: req.user}, 'error')
...
exports.create = function (req, res) {
  utility.callApi(`companyUser/query`, 'post', { domain_email: req.user.domain_email })
    .then(companyUser => {
      ...
      utility.callApi(`pageReferrals/query`, 'post', {pageId: req.body.pageId, companyId: req.user.companyId})
        .then(pageReferrals => {
...
exports.update = function (req, res) {
  utility.callApi(`companyUser/query`, 'post', { domain_email: req.user.domain_email })
    .then(companyUser => {
      ...
      utility.callApi(`pageReferrals/query`, 'post', {_id: req.body._id, companyId: req.user.companyId})
        .then(pageReferrals => {
