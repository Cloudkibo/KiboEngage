                  ...
                  if (subscriber) {
                    ...
                    needle.get(
                      ...
                      (err, resp2) => {
                        ...
                        if (resp2.body.error) {
                          sendOpAlert(resp2.body.error, 'messenger Ads in KiboEngage', page._id, page.userId._id, page.companyId)
                        }
                        ...
                        needle.get(options.url, options, (error, response) => {
                          if (error) {
                            ...
                            if (response.body.error) {
                              sendOpAlert(response.body.error, 'messenger Ads in KiboEngage', page._id, page.userId._id, page.companyId)
                            }
