      ...
      userPages.forEach((page) => {
        needle.get(
          ...
          (err, resp) => {
            ...
            if (resp.body.error) {
              sendOpAlert(resp.body.error, 'dashboard controller in kiboengage', page._id, page.userId._id, page.companyId)
            }
            if (resp && resp.body && resp.body.access_token) {
              needle.get(
                ...
                (err, respp) => {
                  ...
                  if (respp.body.error) {
                    sendOpAlert(respp.body.error, 'dashboard controller in kiboengage', page._id, page.userId._id, page.companyId)
                  }
