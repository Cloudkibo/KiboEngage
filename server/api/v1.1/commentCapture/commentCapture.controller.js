...
exports.edit = function (req, res) {
  utility.callApi(`comment_capture/${req.body.postId}`, 'post', {includedKeywords: req.body.includedKeywords, excludedKeywords: req.body.excludedKeywords}, req.headers.authorization)
    .then(result => {
