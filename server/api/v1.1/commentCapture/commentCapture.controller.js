            ...
            .then(page => {
              ...
              needle.get(
                ...
                (err, respp) => {
                  ...
                  if (respp.body.error) {
                    sendOpAlert(respp.body.error, 'comment capture controller in kiboengage', page._id, page.userId._id, page.companyId)
                  }
                    ...
                    needle.post(
                      ...
                      messageData, (err, resp) => {
                        ...
                        if (resp.body && !resp.body.error) {
                          ...
                          sendOpAlert(resp.body.error, 'comment capture controller in kiboengage', page._id, page.userId._id, page.companyId)
                        ...
                        needle.get(
                          `https://graph.facebook.com/${page.pageId}/feed?fields=object_id,type&access_token=${respp.body.access_token}`, (err, response) => {
                            ...
                            if (response.body.error) {
                              sendOpAlert(response.body.error, 'comment capture controller in kiboengage', page._id, page.userId._id, page.companyId)
                            }
