...
require('./api/global/messageStatistics').recordRedis('test')
require('./api/global/messageStatistics').recordRedis('test2')
require('./api/global/messageStatistics').recordRedis('test')
require('./api/global/messageStatistics').recordRedis('test3')
